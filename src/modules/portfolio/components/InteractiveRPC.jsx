...
import SmartPhoneFrame from "@/common/components/layouts/SmartPhoneFrame";
import { mergeObjects } from "@/common/utils/Utilities";

export default class InteractiveRPC extends Component {
    constructor(props){ //console.group('DEBUG - in InteractiveRPC.constructor')
        super(props)
        ...
        this.state.args.containerAttr.id = 'interactiveRPC'
        //console.groupEnd()
    ...
    componentDidUpdate(prevProps, prevState){ //console.group("DEBUG - in InteractiveRPC.componentDidUpdate()")
